...
.block-container { max-width:720px; padding-top:4.5rem; padding-bottom:2rem; }
h1,h2,h3 { color:var(--ink); }
.app-title { color:var(--ink); font-size:clamp(1.45rem,7vw,2.15rem); font-weight:800;
  line-height:1.15; margin:0; text-align:center; white-space:nowrap; }
...
div[data-testid="stSegmentedControl"] button, div[role="radiogroup"] button {
  min-height:58px; font-size:clamp(1rem,4vw,1.125rem); font-weight:800; border-radius:12px;
  background:#fff; color:var(--ink); border-color:#ccd7d1; padding-inline:.15rem;
  letter-spacing:-.03em; white-space:nowrap;
}
div[data-testid="stSegmentedControl"] > div, div[role="radiogroup"],
div[data-testid="stSegmentedControl"] [data-baseweb="button-group"] { width:100%; display:flex; }
div[data-testid="stSegmentedControl"] button { flex:1 1 50%; }
...
@media(max-width:640px){
  .block-container{padding:4rem .85rem 1.5rem}
...
def input_screen() -> None:
    ...
    with st.form(f"inputs_{mode}", border=False):
